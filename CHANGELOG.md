...
- `docs/CONTINUOUS-VALIDATION.md` — describes the smoketest-driven continuous validation pattern; lists the seven canonical CI failure modes the smoketest has surfaced and where each fix landed. README + PRINCIPLES.md cross-link.
